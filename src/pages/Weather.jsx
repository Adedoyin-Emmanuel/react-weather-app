...
const WeatherApp = () =>{
    ...
    return (
        <React.Fragment>
            <div className="container-fluid d-flex flex-column py-2 " style={{"overflowX":"hidden"}}>
            ...
            <section className="future-weather-forecast my-4">
                ...
                <div id="myCarousel" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Slide 1">Today</button>
                    <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="1" aria-label="Slide 2">tomorrow</button>
                    <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="2" aria-label="Slide 3">10 days</button>
                    </div>
                ...
                <div className="carousel-item active">
                        ...
                        <div className="container brand-secondary-color">
