...
const FutureWeatherComponent = props =>{
   const customStyle = {
    ...
    return (
       <React.Fragment>
            <section style={customStyle} className="future-weather-container d-flex align-items-center justify-content-center flex-column brand-bg-white px-4  rounded-3 shadow-sm mx-2 my-2" onClick={props.onClick}>
                <section className="weather-wrapper d-flex flex-column align-items-center justify-content-center">
                    ...
                    <section className="weather-icon-section py-1">
                            <img src ={"sub-weather-icon"} height={"40"} width={"50"}/>
                    </section>
